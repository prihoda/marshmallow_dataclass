    ...
    try:
        ...
        try:
            warnings.warn(
                ...
                f"marshmallow_dataclass, or are already dataclasses. For more information, see "
                f"https://github.com/lovasoa/marshmallow_dataclass#automatic-dataclass-conversion "
                f"****** WARNING ******"
            )
